    ...
    <section className="flex flex-col text-center my-8">
      ...
      <section className="flex justify-center gap-2 my-2">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="bg-black/70 hover:bg-black pl-2 pr-4 py-1 text-white flex items-center rounded-full"
        >
          <AiFillGithub size={20} className="mb-0.5" />
          <span className="ml-3 mr-4">GitHub</span>
        </a>
      </section>
    </section>
  );
