...
export default function ContactForm() {
  ...
  return (
    <section className="w-full">
       ...
       */}
      <div className="px-4 mb-6 rounded-lg flex flex-col items-center font-medium bg-emerald-50 py-6 text-emerald-700 ">
        <div className="rounded-full w-24 h-24 mb-4 flex justify-center items-center bg-white">
          <BsSendCheck size={56} className="mr-2 mt-1 text-emerald-600" />
        </div>
