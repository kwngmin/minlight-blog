...
export default function ContactForm() {
  ...
  return (
    <section className="w-full">
       ...
       */}
      <div className="px-4 mb-6 rounded flex flex-col items-center font-medium bg-emerald-50 py-4 text-emerald-700 ">
        <div className="rounded-full w-28 h-28 mb-4 flex justify-center items-center border-8 bg-emerald-200 border-emerald-100">
          <BsSendCheck size={64} className="mr-2 text-emerald-600" />
        </div>
