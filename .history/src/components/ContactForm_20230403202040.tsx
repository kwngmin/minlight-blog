...
export default function ContactForm() {
  ...
  return (
    <section className="w-full">
       ...
       */}
      <div className="px-4 py-8 mb-6 rounded flex flex-col items-center text-emerald-800">
        <div className="bg-emerald-200 rounded-full bg-white w-24 h-24 mb-4 flex justify-center items-center">
          <BsSendCheck size={64} className="text-black" />
        </div>
