    ...
    <section className="flex flex-col text-center my-8">
      ...
      <section className="flex justify-center gap-2 my-2">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="ring-1 ring-gray-300 hover:bg-gray-100 px-5 py-1 font-medium text-black/70 flex items-center rounded-full"
        >
          <AiFillGithub size={18} className="mr-2" /> GitHub
        </a>
        {/* <a
          href="https://github.com/kwngmin"
          target="_blank"
