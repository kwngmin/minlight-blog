...
export default function ContactForm() {
  ...
  return (
    <section className="w-full">
       ...
       */}
      <div className="bg-green-50 px-4 py-8 mb-6 rounded flex flex-col items-center text-emerald-600">
        <BsSendCheckFill className="text-4xl mb-3" />
        <span>{`이메일을 성공적으로 발송했습니다`}</span>
      </div>
      <form
        onSubmit={onSubmit}
