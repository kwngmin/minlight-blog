    ...
    <section className="flex flex-col text-center my-8">
      ...
      <section className="flex justify-center gap-2 my-4">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="ring-1 lg:hover:ring-0 ring-slate-300 lg:hover:bg-black px-5 font-medium text-slate-600 lg:hover:text-white rounded-full"
        >
        ...
        <Link href="/contact">
          <button className="rounded-full bg-slate-500  lg:hover:bg-slate-600 px-5 h-10 text-white/90 font-medium">
            Contact Me
          </button>
        </Link>
      </section>
