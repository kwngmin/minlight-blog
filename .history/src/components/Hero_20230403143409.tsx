    ...
    <section className="flex flex-col text-center my-8">
      ...
      <section className="flex justify-center gap-2 my-2">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="border hover:bg-black/10 pl-1 pr-4 py-1 text-black/70 flex items-center rounded-full"
        >
          <AiFillGithub size={22} className="mb-0.5" />
          <span className="ml-3 mr-2 font-medium">GitHub</span>
        </a>
      </section>
    </section>
  );
