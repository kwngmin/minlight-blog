...
export default function ContactForm() {
  ...
  return (
    <section className="w-full">
       ...
       */}
      <div className="px-4 mb-6 rounded flex flex-col items-center text-emerald-800 font-semibold">
        <div className="bg-emerald-200 rounded-full w-28 h-28 mb-4 flex justify-center items-center">
          <BsSendCheck size={64} className="text-black mr-2" />
        </div>
