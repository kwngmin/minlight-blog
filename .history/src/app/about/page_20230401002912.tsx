export default function AboutPage() {
  ...
  return (
    <div>
      <article className="max-w-screen-md mx-auto p-8">
        <h2 className="text-3xl font-semibold text-slate-600 border-b py-12">
          Experienced at 👨🏻‍💻
        </h2>
        <ul>
          {careerData.map(({ company, role, period }) => (
            <li key={company} className="flex items-center h-16 border-b">
              <h3 className="font-bold text-xl w-1/6 text-black/70">
                {company}
              </h3>
