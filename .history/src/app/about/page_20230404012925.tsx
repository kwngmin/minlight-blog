...
export default function AboutPage() {
  ...
  const educateData = [
    ...
    },
    {
      ...
      role: "Digital Media Design Major ·
      Master of Design",
  ...
  return (
    <>
      ...
      <section className="my-8">
        ...
        <ul className="flex lg:justify-start justify-center items-center h-28 lg:h-16 border-t gap-2 lg:gap-4 px-4 lg:px-8 flex-wrap content-center">
          {stacks.map((stack, index) => (
            <li
              className="font-semibold lg:text-lg bg-slate-100 px-2 lg:px-3 py-1"
              key={index}
            >
              {stack}
            </li>
