  ...
  return (
    <>
      ...
      <section className="my-8">
        ...
        <ul className="flex lg:justify-start justify-center items-center h-28 lg:h-16 border-t gap-0 lg:gap-4 px-8 flex-wrap">
          {stacks.map((stack, index) => (
            <li
              className="font-semibold text-lg bg-slate-100 px-3 py-1"
              key={index}
            >
              {stack}
            </li>
