  ...
  return (
    <>
      ...
      <section className="my-8">
        ...
        <ul className="flex lg:justify-start justify-center items-center h-28 lg:h-16 border-t gap-1 lg:gap-2 lg:px-8 flex-wrap content-center">
          {stacks.map((stack, index) => (
            <li
              className="font-semibold text-lg bg-slate-100 px-2 lg:px-3 py-1 rounded-full"
              key={index}
            >
              {stack}
            </li>
