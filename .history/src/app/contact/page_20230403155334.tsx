    ...
    <section className="flex flex-col items-center gap-1">
      ...
      <ul className="flex justify-center items-center gap-2">
        <a
          ...
          className="px-6 rounded-full bg-zinc-100 hover:bg-zinc-200 py-2 border"
        >
          kwngmin.k@gmail.com
        </a>
        {LINKS.map(({ url, icon }, index) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-2xl text-black/80 bg-zinc-100 hover:bg-zinc-200 rounded-full p-2 border"
          >
            {icon}
          </a>
        ))}
