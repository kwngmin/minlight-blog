    ...
    <section className="flex flex-col items-center gap-1">
      ...
      <ul className="flex justify-center items-center">
        <a
          ...
          className="px-4 rounded-full hover:bg-black hover:text-white py-2"
        >
          kwngmin.k@gmail.com
        </a>
        {LINKS.map(({ url, icon }, index) => (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-2xl text-black/80 hover:bg-black hover:text-white rounded-full p-2 mx-1"
          >
            {icon}
          </a>
        ))}
